                ...
                <div class="content-column col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <div class="sec-title light">
                            <h2>
                                @if (isset($WhyChooseOurService))
                                    {{ $WhyChooseOurService->title }}
                                @else
                                    لا يوجد
                                @endif
                            </h2>
                        ...
                        <div class="image-box">
                            @if (isset($WhyChooseOurService))
                                {{-- <figure class="image overlay-anim"><a href="page-about.html"><img
                                            src="{{ asset('storage/' . $WhyChooseOurService->image) }}" alt></a>
                                </figure> --}}
                                <figure class="image overlay-anim">
                                    <x-curator-glider :media="$WhyChooseOurService->image" :alt="$WhyChooseOurService->title" />
                            @endif
