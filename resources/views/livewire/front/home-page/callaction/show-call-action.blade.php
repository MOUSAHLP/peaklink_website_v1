<div>
    ...
    <section class="contact-banner pt-0">
        <div class="auto-container">
            <div class="outer-box" style="padding: 55px 100px;
            background-image: url('{{ asset("storage/".$callAction->background_image) }}');
            ...
            justify-content: space-between;">
                ...
                <a href="mailTo:{{ $callAction->button_link }}" class="theme-btn-v2">{{ $callAction->button_title }} <i
