        ...
        <div class="auto-container">
            ...
            <div class="row">
                ...
                <div class="news-block col-lg-4 col-md-6">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><a href="news-details.html"><img src="{{ asset('storage/'.$Post->image) }}"
                                        alt></a></figure>
                        </div>
                        <div class="content-box">
                                ...
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                        ...
                                        <path opacity="0.8"
                                            ...
                                            fill="#F94A29" />
                                    </svg>{{ $Post->created_at->diffForHumans() }}</li>
                                </li>
                                <li>
                            ...
                            <h6 class="title"><a href="news-details.html">
                                {{ $Post->title }}
                                    </a></h6>
                        </div>
                    </div>
