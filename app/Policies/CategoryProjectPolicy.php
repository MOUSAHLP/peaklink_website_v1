...
class CategoryProjectPolicy
{
    ...
    {
        return $user->can('view_any_category::project');
    }
    ...
    {
        return $user->can('view_category::project');
    }
    ...
    {
        return $user->can('create_category::project');
    }
    ...
    {
        return $user->can('update_category::project');
    }
    ...
    {
        return $user->can('delete_category::project');
    }
    ...
    {
        return $user->can('delete_any_category::project');
    }
     ...
     * @return bool
     */
    public function replicate(User $user, CategoryProject $categoryProject): bool
    {
        return $user->can('replicate_category::project');
    }
    ...
    {
        return $user->can('reorder_category::project');
    }
